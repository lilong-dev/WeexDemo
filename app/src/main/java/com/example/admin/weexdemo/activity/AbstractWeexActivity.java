...
import com.example.admin.weexdemo.utils.AssertUtil;
...
public abstract class AbstractWeexActivity extends AppCompatActivity implements IWXRenderListener {
  ...
  protected void renderPageByURL(String url,String bundleUrl){
    renderPageByURL(url,bundleUrl,null);
  }
  ...
  protected void renderPageByURL(String url,String bundleUrl,String jsonInitData){
    AssertUtil.throwIfNull(mContainer,new RuntimeException("Can't render page, container is null"));
    Map<String, Object> options = new HashMap<>();
